...
//    CrossPD = MENU_fileInit(CrossPD, 1, 0.5, "cross", 2, none, NULL, &CrossCircle, &file3, &Cross_PB);
    ...
    cross_circle_param1 = MENU_fileInit(cross_circle_param1, 91, 1.0, "vision", 2, dataint, NULL, &cross_circle_param2, &cross_circle, NULL);
    cross_circle_param2 = MENU_fileInit(cross_circle_param2, -1, 1.0, "rightX", 3, dataint, &cross_circle_param1, &cross_circle_param3, NULL, NULL);
    cross_circle_param3 = MENU_fileInit(cross_circle_param3, -1, 1.0, "leftX", 4, dataint, &cross_circle_param2, &cross_circle_param4, NULL, NULL);
    cross_circle_param4 = MENU_fileInit(cross_circle_param4, 18, 1.0, "outwidth", 5, dataint, &cross_circle_param3, &cross_circle_param5, NULL, NULL);
    ...
    folkParam1 = MENU_fileInit(folkParam1, 20, 1.0, "width", 2, dataint, NULL, &folkParam2, &folkWay, NULL);
...
//    Cross_DB = MENU_fileInit(Cross_DB, 1, 0.5, "D-BIG", 4, datafloat, &Cross_DS, NULL, NULL, NULL);
    ...
    circle_DS = MENU_fileInit(circle_DS, 1, 3.1, "D-SMALL", 3, datafloat, &circle_NB, NULL, NULL, NULL);
...
//    Island_NB = MENU_fileInit(Island_NB, 1, 3.7, "IslandNB", 3, datafloat, &Island_PB, &Island_DS, NULL, NULL);
    Island_DS = MENU_fileInit(Island_DS, 1, 3.1, "D-SMALL", 5, datafloat, &Island_PS, NULL, NULL, NULL);
...
//    currentKD = MENU_fileInit(currentKD, 2, 3.0, "motorKD", 4, datafloat, &currentRTKI, &expectC, NULL, NULL);
    ...
    fuzzyPB = MENU_fileInit(fuzzyPB, 1, 3.5, "fuzzyPB", 5, datafloat, &presentVision, &fuzzyPM, NULL, NULL);
    ...
    fuzzyNB = MENU_fileInit(fuzzyNB, 1, 3.5, "fuzzyNB", 5, datafloat, &fuzzyNM, &presentServoD, NULL, NULL);
...
//    preGear3 = MENU_fileInit(preGear3, 1, 1.0, "Present3", 3, none, &g3_Data7, NULL, NULL, &presentSpeed);
    ...
    LFKI = MENU_fileInit(LFKI, 19, 1.5, "KI-P", 3, dataint, &LFKP, &RTKP, NULL, NULL);
