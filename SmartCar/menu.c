...
//    CrossPD = MENU_fileInit(CrossPD, 1, 0.5, "cross", 2, none, NULL, &CrossCircle, &file3, &Cross_PB);
    ...
    islandParam2 = MENU_fileInit(islandParam2, 88, 1.8, "vision", 5, dataint, &islandParam1, &islandParam3, NULL, NULL);
...
//    Island_NB = MENU_fileInit(Island_NB, 1, 3.7, "IslandNB", 3, datafloat, &Island_PB, &Island_DS, NULL, NULL);
    Island_DS = MENU_fileInit(Island_DS, 1, 4, "D-SMALL", 5, datafloat, &Island_PS, NULL, NULL, NULL);
