...
void MENU_Init()//存取数据时最后一个数据不能操作，待解决
{
    ...
    curveDiff = MENU_fileInit(curveDiff, 1, 1, "curveL", 2, datafloat, NULL, &islandDiff, &file3, NULL);
    ...
    curveDiffLine = MENU_fileInit(curveDiffLine, 95, 1, "curveR", 7, datafloat, &folkDiff2, NULL, NULL, NULL);
...
//    CrossPD = MENU_fileInit(CrossPD, 1, 0.5, "cross", 2, none, NULL, &CrossCircle, &file3, &Cross_PB);
    ...
    bigParam1 = MENU_fileInit(bigParam1, -5, 1.0, "upPoint", 2, dataint, NULL, &bigParam2, &bigIsland, NULL);
    ...
    bigParam5 = MENU_fileInit(bigParam5, -5, 0, "xleft", 6, dataint, &bigParam4, &bigParam6, NULL, NULL);
    bigParam6 = MENU_fileInit(bigParam6, -5, 0, "xright", 7, dataint, &bigParam5, &bigParam7, NULL, NULL);
    ...
    islandParam2 = MENU_fileInit(islandParam2, 82, 1.8, "vision", 5, dataint, &islandParam1, &islandParam3, NULL, NULL);
    ...
    cross_circle_param1 = MENU_fileInit(cross_circle_param1, 80, 1.0, "vision", 2, dataint, NULL, &cross_circle_param2, &cross_circle, NULL);
    ...
    cross_circle_param5 = MENU_fileInit(cross_circle_param5, 0, 0, "leftK", 6, datafloat, &cross_circle_param4, &cross_circle_param6, NULL, NULL);
    cross_circle_param6 = MENU_fileInit(cross_circle_param6, 0, 0, "rightK", 7, datafloat, &cross_circle_param5, &cross_circle_param7, NULL, NULL);
    ...
    search_line = MENU_fileInit(search_line, 30, 1.0, "line", 5, dataint, &endGyro, &parkDelay, NULL, NULL);
    ...
    folkParam3 = MENU_fileInit(folkParam3, 0, 1.0, "up-move", 4, dataint, &folkParam2, NULL, NULL, NULL);
...
//    Cross_DB = MENU_fileInit(Cross_DB, 1, 0.5, "D-BIG", 4, datafloat, &Cross_DS, NULL, NULL, NULL);
    ...
    circle_PB = MENU_fileInit(circle_PB, 1, 2.1, "circleL", 2, datafloat, NULL, &circle_PM, &CrossCircle, NULL);
    circle_PM = MENU_fileInit(circle_PM, 1, 2.1, "circleR", 3, datafloat, &circle_PB, &circle_DS, NULL, NULL);
...
//    circle_DB = MENU_fileInit(circle_DB, 1, 0.5, "D-BIG", 4, datafloat, &circle_DS, NULL, NULL, NULL);
    ...
    Island_PS = MENU_fileInit(Island_PS, 1, 2.1, "SMALL-I", 4, datafloat, &Island_PM, &Island_DS, NULL, NULL);
...
//    Island_NB = MENU_fileInit(Island_NB, 1, 3.7, "IslandNB", 3, datafloat, &Island_PB, &Island_DS, NULL, NULL);
    ...
    Island_DB = MENU_fileInit(Island_DB, 1, 4, "D-BIG", 6, datafloat, &Island_DS, NULL, NULL, NULL);
...
//    g3_Data7 = MENU_fileInit(g3_Data7, 119, 1.1, "motor-I", 2, datafloat, &g3_Data6, &preGear3, NULL, NULL);
    ...
    currentK = MENU_fileInit(currentK, 1, 1.0, "currentK", 3, none, NULL, &gear1, NULL, NULL);
    currentRTKP = MENU_fileInit(currentRTKP, 3, 3.6, "curRTKP", 2, datafloat, NULL, &currentRTKI, &currentMotor, NULL);
    currentRTKI = MENU_fileInit(currentRTKI, 2, 4.2, "curRTKI", 3, datafloat, &currentRTKP, &currentLFKP, NULL, NULL);
    currentLFKP = MENU_fileInit(currentLFKP, 3, 3.6, "curLFKP", 4, datafloat, &currentRTKI, &currentLFKI, &currentK, NULL);
    currentLFKI = MENU_fileInit(currentLFKI, 2, 4.2, "curLFKI", 5, datafloat, &currentLFKP, &expectC, NULL, NULL);
//    currentKD = MENU_fileInit(currentKD, 2, 3.0, "motorKD", 4, datafloat, &currentRTKI, &expectC, NULL, NULL);
    ...
    part_klow2 = MENU_fileInit(part_klow2, 63, 0.9, "minthre", 4, dataint, &part_khigh1, &part_khigh2, NULL, NULL);
    part_khigh2 = MENU_fileInit(part_khigh2, 130, 1.0, "maxthre", 5, dataint, &part_klow2, NULL, NULL, NULL);
    presentTHRE = MENU_fileInit(presentTHRE, 48, 2.2, "THRE", 5, dataint, &partOTSU, NULL, NULL, NULL);
...
//    expTime = MENU_fileInit(expTime, 300, 1.0, "exptime", 5, dataint, &partOTSU, NULL, NULL, NULL);
    ...
    KdSmall = MENU_fileInit(KdSmall, 1, 4.6, "KdSMALL", 4, datafloat, &KdMid, &KdZero, NULL, NULL);
    KdZero = MENU_fileInit(KdZero, 1, 4.8, "KdZO", 5, datafloat, &KdSmall, NULL, NULL, NULL);

    /* 当下的电机pwm值（speedL/R）和摄像头前瞻vision */
    presentSpeed = MENU_fileInit(presentSpeed, 90, 1.1, "speed", 2, dataint, NULL, &vision, &file2, NULL);
    presentVision = MENU_fileInit(presentVision, 83, 3.3, "VISION", 2, dataint, NULL, &slowVision, &vision, NULL);
    ...
    fuzzyPB = MENU_fileInit(fuzzyPB, 1, 2.1, "fuzzyPB", 2, datafloat, NULL, &fuzzyPM, &KpFuzzy, NULL);
    fuzzyPM = MENU_fileInit(fuzzyPM, 1, 1.9, "fuzzyPM", 3, datafloat, &fuzzyPB, &fuzzyPS, NULL, NULL);
    fuzzyPS = MENU_fileInit(fuzzyPS, 1, 1.8, "fuzzyPS", 4, datafloat, &fuzzyPM, &fuzzyZO, NULL, NULL);
    fuzzyZO = MENU_fileInit(fuzzyZO, 1, 1.8, "fuzzyZO", 5, datafloat, &fuzzyPS, &fuzzyNS, NULL, NULL);
    fuzzyNS = MENU_fileInit(fuzzyNS, 1, 1.8, "fuzzyNS", 6, datafloat, &fuzzyZO, &fuzzyNM, NULL, NULL);
    fuzzyNM = MENU_fileInit(fuzzyNM, 1, 1.9, "fuzzyNM", 7, datafloat, &fuzzyNS, &fuzzyNB, NULL, NULL);
    fuzzyNB = MENU_fileInit(fuzzyNB, 1, 2.1, "fuzzyNB", 2, datafloat, &fuzzyNM, &kpbottom, NULL, NULL);
...
//    preGear3 = MENU_fileInit(preGear3, 1, 1.0, "Present3", 3, none, &g3_Data7, NULL, NULL, &presentSpeed);
    ...
    LFKI = MENU_fileInit(LFKI, 21, 1.5, "KI-P", 3, dataint, &LFKP, &RTKP, NULL, NULL);
    RTKP = MENU_fileInit(RTKP, 17, 3.8, "KI-N", 4, dataint, &LFKI, &RTKI, NULL, NULL);
    RTKI = MENU_fileInit(RTKI, 15, 1.5, "stopKP", 5, dataint, &RTKP, &fastLFKP, NULL, NULL);
...
//    slowRTKI = MENU_fileInit(slowRTKI, 15, 133.03, "slowRTKI", 5, dataint, &slowRTKP, NULL, NULL, NULL);
    ...
    display3 = MENU_fileInit(display3, 40, 1, "speedDown", 4, datafloat, &display2, NULL, NULL, NULL);

    speedFilter = MENU_fileInit(speedFilter, 40, 1, "alpha", 2, datafloat, NULL, &currentFilter1, &allFilter, NULL);
    ...
    currentKdLpf = MENU_fileInit(currentKdLpf, 40, 0.9, "curD", 5, datafloat, &currentFilter2, &speedKdLpf, NULL, NULL);
    speedKdLpf = MENU_fileInit(speedKdLpf, 40, 0.9, "speD", 6, datafloat, &currentKdLpf, &filterBottom, NULL, NULL);
    filterBottom = MENU_fileInit(filterBottom, 40, 0.9, "bottom", 7, none, &speedKdLpf, NULL, NULL, NULL);

//    display4 = MENU_fileInit(display4, 10, 0.5, "no1", 5, datafloat, &display3, &display5, NULL, NULL);              //没用
//    display5 = MENU_fileInit(display5, 10, 0.3, "no2", 6, datafloat, &display4, &display6, NULL, NULL);          //没用
//    display6 = MENU_fileInit(display6, 2, 1, "no3", 7, datafloat, &display5, &display7, NULL, NULL);
//    display7 = MENU_fileInit(display7, 100, 0.9, "no4", 2, datafloat, &display6, &display8, NULL, NULL);
//    display8 = MENU_fileInit(display8, 130, 7.91, "no3", 3, dataint, &display7, &display9, NULL, NULL);
//    display9 = MENU_fileInit(display9, 1, 9.02, "no4", 4, dataint, &display8, NULL, NULL, NULL);
...
//             SmartCar_OLED_P6x8Str(100, 2, "down");
        ...
        {
            SmartCar_OLED_P6x8Str(100, 0, "org");
